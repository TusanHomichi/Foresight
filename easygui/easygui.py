...
def diropenbox(msg=None, title=None, default=None):
    ...
    root.destroy()    #!added in version 0.85
...
# fileopenbox
#-------------------------------------------------------------------
def fileopenbox(msg=None, title=None, default="*"):
    """
    ...
    root = Tk()
    root.withdraw()
    f = tkFileDialog.askopenfilename(parent=root
        , title=getFileDialogTitle(msg,title)     #!modified in version 0.84
        , filetypes=[(default,default)]           #!modified in version 0.84
        )
    root.destroy()    #!added in version 0.85
    if not f: return None
    return os.path.normpath(f)
...
def filesavebox(msg=None, title=None, default="*"):
    ...
    root = Tk()
    root.withdraw()
    f = tkFileDialog.asksaveasfilename(parent=root
        , title=getFileDialogTitle(msg,title)     #!modified in version 0.84
        , filetypes=[(default,default)]           #!modified in version 0.84
        )
    root.destroy()    #!added in version 0.85
...
*5)+"\n\n")*10
    ...
    while 1: # do forever
        ...
        if   reply[0] == "msgbox":
            ...
            f = fileopenbox(None,None,default=mask)
            print("You chose to open file: %s" % f)

            f = fileopenbox(msg,title,default=mask)
            print("You chose to open file: %s" % f)

            f = fileopenbox(None,title,default=mask)
            print("You chose to open file: %s" % f)

            f = fileopenbox(msg,None,default=mask)
            print("You chose to open file: %s" % f)

            f = fileopenbox(default=mask)
            print("You chose to open file: %s" % f)
            ...
            print("You chose to save file: %s" % f)
